#
# Sphinx configuration for aiida-quad
#
...
release = aiida_quad.__version__
...
html_title = f"aiida-quad v{release}"
html_theme_options = {}
...
html_use_opensearch = "https://aiida-quad.readthedocs.io"
...
def run_apidoc(_):
    ...
    package_dir = os.path.join(source_dir, os.pardir, os.pardir, "src", "aiida_quad")
